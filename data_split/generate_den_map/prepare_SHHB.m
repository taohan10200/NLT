...
path = ['E:/DataSet/ShanghaiTech_Crowd_Counting_Dataset/part_' dataset '_final/' att '_data/images/'];
output_path = 'E:DataSet/ShanghaiTech_Crowd_Counting_Dataset/768x1024RGB-k15-s4/';
train_path_img = strcat(output_path, dataset_name,'/', att, '/img/');
train_path_den = strcat(output_path, dataset_name,'/', att, '/den/');

gt_path = ['E:/DataSet/ShanghaiTech_Crowd_Counting_Dataset/part_' dataset '_final/' att '_data/ground_truth/'];
