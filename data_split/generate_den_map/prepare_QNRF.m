...
% 
% %% test set
% path ='E:/Crowd_Count_DataSet/UCF-QNRF_ECCV18/Test\';
% output_path = 'E:/Crowd_Count_DataSet/UCF-QNRF_ECCV18/test';
...
%% train set
path ='E:/Crowd_Count_DataSet/UCF-QNRF_ECCV18/Train\';
output_path = 'E:/Crowd_Count_DataSet/UCF-QNRF_ECCV18/Train';
train_path_img = strcat(output_path,'/', 'img/');
train_path_den = strcat(output_path,'/', 'den/');
